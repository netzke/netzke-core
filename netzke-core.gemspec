...
Gem::Specification.new do |s|
  ...
  s.files = [
    ".autotest",
     ...
     "test/rails_app/app/components/netzke/border_layout_panel.rb",
     "test/rails_app/app/components/netzke/component_loader.rb",
     "test/rails_app/app/components/netzke/component_that_has_actions.rb",
     "test/rails_app/app/components/netzke/component_with_custom_css.rb",
     "test/rails_app/app/components/netzke/component_with_session_persistence.rb",
     "test/rails_app/app/components/netzke/composite_two.rb",
     "test/rails_app/app/components/netzke/custom.css",
     "test/rails_app/app/components/netzke/custom_styles.rb",
     "test/rails_app/app/components/netzke/deprecated/server_caller.rb",
     "test/rails_app/app/components/netzke/extended_server_caller.rb",
     "test/rails_app/app/components/netzke/kinda_complex_component.rb",
     "test/rails_app/app/components/netzke/kinda_complex_component/basic_stuff.rb",
     "test/rails_app/app/components/netzke/kinda_complex_component/extra_stuff.rb",
     "test/rails_app/app/components/netzke/loader_of_component_with_custom_css.rb",
     "test/rails_app/app/components/netzke/scoped_components/deep_scoped_components/some_deep_scoped_component.rb",
     "test/rails_app/app/components/netzke/scoped_components/extended_scoped_component.rb",
     "test/rails_app/app/components/netzke/scoped_components/some_scoped_component.rb",
     "test/rails_app/app/components/netzke/server_caller.rb",
     "test/rails_app/app/components/netzke/simple_component.rb",
     "test/rails_app/app/components/netzke/simple_panel.rb",
     "test/rails_app/app/components/netzke/some_composite.rb",
     "test/rails_app/app/components/netzke/some_ext_component.rb",
     "test/rails_app/app/components/netzke/tab_panel.rb",
