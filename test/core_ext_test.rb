...
class CoreExtTest < ActiveSupport::TestCase
  test "to_js" do
    assert_equal('{"aProperty": true}', {:a_property => true}.to_js)
    assert_equal('{"aProperty": true}', {:a_property => true, :nil_property => nil}.to_js)
    assert_equal('[{"aProperty": true}, {"anotherProperty": false}]', [{:a_property => true}, {:another_property => false}].to_js)
    assert_equal('[{"aProperty": true}, {"anotherProperty": false}]', [{:a_property => true, :nil_property => nil}, {:another_property => false}].to_js)
  end
