...
```javascript
Ext.define('Netzke.classes.HelloWorld', {"extend":"Ext.panel.Panel", "mixins":["Netzke.Core.Mixin"]});
```

`Netzke.Core.Mixin` contains a set of client class methods and properties common to every Netzke component.
