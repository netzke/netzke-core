...
* enhancements
  ...
  * Set JS class property +load_mask_msg+ if you want to see a mask when a component gets dynamically loaded with +loadComponent+. Also +load_mask_msg_cls+ will be used as the second param for the Ext.Element#mask call, and defaults to "x-mask-loading".
