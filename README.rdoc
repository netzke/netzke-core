...
netzke-core has support for Sencha Touch. Create reusable code for Sencha Touch with the same ease as you do for Sencha Ext, getting *reusability*, *composition*, *inheritance*, and dead-simple <strong>client-server communication</strong> out-of-the-box.
