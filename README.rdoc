...
Create YOUR_APP/app/components/hello_world_component.rb, and put in the following content:
    ...
    class HelloWorldComponent < Netzke::Base
      ...
      js_property :bbar, [:bug_server.ext_action]
...
The bundled test/rails_app application is also a convenient playground, as it may be run as a stand-alone Rails app. After starting it, access any of the app/components/netzke test components by using the following url:
