...
== Running the tests
netzke-core is bundled with a test Rails app which can be run independently. Check its source code to get an idea about the key functionality of the framework.
