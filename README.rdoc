...
== Tests
netzke-core is bundled with a well documented testing Rails app which can be run independently. Check its source code to get an idea about the basic functionality of the framework.
