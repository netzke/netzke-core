      ...
      module Ext #:nodoc:
        ...
        protected
          ...
          def netzke_ext_css_include(theme)
            # ExtJS base
            res = stylesheet_link_tag("/extjs4/resources/css/ext-all")
          ...
          def netzke_ext_js_include
            ...
            # ExtJS
            res << (ENV['RAILS_ENV'] == 'development' ? javascript_include_tag("/extjs4/ext-core-debug", "/extjs4/ext-all-debug") : javascript_include_tag("/extjs4/ext-core", "/extjs/ext-all"))
